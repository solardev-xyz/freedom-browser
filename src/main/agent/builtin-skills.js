...
const BUILTIN_SKILL_DEFINITIONS = Object.freeze([
  Object.freeze({ name: 'workspace-history', description: 'Review project changes and commit selected file revisions in the project repository when authorized.', files: Object.freeze(['SKILL.md']) }),
  Object.freeze({
    name: 'swarm-postage',
    description:
