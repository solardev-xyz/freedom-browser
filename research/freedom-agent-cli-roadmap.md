...
The numbered inventory below records completed foundations and remaining capabilities; it is not execution order. The dependency-based app workflow above has completed user acceptance; the next feature milestone has not yet been selected.
