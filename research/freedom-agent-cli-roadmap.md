...
- The next slice is Freedom-owned checkpoints after file-changing turns, user-named versions, and inspection/restoration with preservation of current work. It still needs explicit rules for interrupted turns, secret exclusions beyond patterns, large files, and edits from running processes. Agent commits/branches/staging and remote publication are separate later decisions. Do not describe this first slice as automatic recovery history.
