...
Current local verification baseline after the dependency-setup corrections (2026-09-05): 229 suites and 3,994 tests passed, with 7 suites / 51 tests skipped on macOS; lint and diff checks passed. Existing OpenLV/websocket-mqtt late-log warnings did not fail the suite.
